...
public class AdminStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Staff_id", "StaffName", "Workinghours", "Email", "Salary", "SPhoneNo"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                String Staff_id = String.valueOf(rs.getInt("sid"));
                String StaffName = rs.getString("sname");
                String WorkingHours= String.valueOf(rs.getInt("workinghours"));
                String Email = rs.getString("semail");
                String Salary = rs.getString("salary");
                String SPhoneNo = String.valueOf(rs.getLong("sphoneno"));
             
                
                String tbdata[] = {Staff_id, StaffName,WorkingHours, Email, Salary, SPhoneNo};
