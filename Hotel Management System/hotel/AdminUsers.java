...
public class AdminUsers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cust_id", "FirstName", "LastName", "Username", "DateOfBirth", "Email", "Gender", "AadharNumber"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                //String  = String.valueOf(rs.getInt("fname"));
                String FirstName = rs.getString("fname");
                String LastName = rs.getString("lname");
                String Username = rs.getString("username");
                String DateOfBirth = String.valueOf(rs.getDate("dob"));
                String Email = rs.getString("email");
                String Gender = rs.getString("gender");
                String AadharNumber = rs.getString("aadharno");
             
                
                String tbdata[] = {Cust_id, FirstName, LastName, Username, DateOfBirth, Email, Gender, AadharNumber};
